...
pipeline {
    agent none
    parameters {
        string(name: 'targetPath', defaultValue: 'liubility-gateway/target/', description: '生成jar包路径')
        string(name: 'serverPath', defaultValue: '/usr/local/src/liubility/gateway', description: '远程服务路径')
